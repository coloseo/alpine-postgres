...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-postgres:${tag}" "asia.gcr.io/saas-orangesys-io/alpine-postgres:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker -- push asia.gcr.io/saas-orangesys-io/alpine-postgres:${tag}
done
